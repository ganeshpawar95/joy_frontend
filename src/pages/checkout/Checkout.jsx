          ...
          <div class="container">
            <div class="row">
              <div class="col-md-7 check-left">
                <form id="myform1" action="post" class="checkout_form">
                  <div class="check-left-box">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input
                          type="text"
                          class="input-box w-full numbers"
                          name="contact_mobile"
                      ...
                      >
                        ★ We will contact to this number if there is any issue
                        with the order.
                      </span>
                    </div>
                    <br />
                    ...
                    <div class="row" style={{ "margin-top": "20px;" }}>
                      ...
                      <div class="col-md-4">
                        <select class="input-box w-full" name="state">
                      ...
                      <div class="col-md-4">
                        <select class="input-box w-full" name="country">
                          <option>India</option>
                        </select>
                      </div>
                      <div class="col-md-4">
              ...
              <div class="col-md-5 check-right">
                <div
                  ...
                  style={{
                    ...
                    "box-shadow": "rgb(100 100 111 / 46%) 0px 7px 29px 0",
                  }}
                >
                  <h2>Apply Coupon</h2>
                  <div class="row">
                    <div class="col-md-8">
                      <input
                        type="text"
                        class="input-box w-full code"
                        placeholder="Coupon Code"
                      />
                    </div>
                    <div class="col-md-4">
                      <button class="btn-aply apply_code" type="button">
                        Apply
                      </button>
                    </div>
                  </div>
